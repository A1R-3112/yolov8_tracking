...
from reid.utils.util import calc_distance, cos_sim_distance
from reid.settings import ReID
...
def run(
    ...
    if reid_model !=None:
        setting = ReID(reid_model)
        reid = ReidHelper(setting)
        query_lst = []
        query_id = 0
        feat1_dict = {}
        frame_dict = {}
